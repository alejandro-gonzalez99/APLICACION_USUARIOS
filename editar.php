...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $query = $conn->prepare("UPDATE usuarios SET nombres=:nombres, correo=:correo, telefono=:telefono, direcccion=:direcccion WHERE id=:id");
...
<html lang="en">
    ...
    <body>
        ...
        <h3 class="text-center">Edición de usuarios (UPDATE)</h3>
        <br><br>
        <form action="" method="post">
            ...
            <div class="mb-3">
                ...
                placeholder="Digite su nombre completo con sus dos apellidos" required/>
                </div>
                ...
                placeholder="Digite su número de teléfono"required/>
                </div>
                ...
                placeholder="Digite su dirección completa"required/>
                </div>
